...
export default function TripsStub() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center p-6 border border-dashed border-slate-800 rounded-2xl bg-slate-900/10">
      ...
      <h2 className="text-lg font-semibold text-slate-200">Trip Dispatching</h2>
      <p className="text-xs text-slate-500 max-w-sm mt-1">
        This screen is reserved for **Person B** to implement the dispatch workflows, weight limits validation, and vehicle status updates.
      </p>
    </div>
  );
}
